package com.CRUD.CRUD_APPLICATION.controllers;
import com.CRUD.CRUD_APPLICATION.models.Product;
import com.CRUD.CRUD_APPLICATION.models.ProductDto;
import com.CRUD.CRUD_APPLICATION.services.ProductsRepository;
...
public class ProductsController {
    ...
    public String updateProduct(
            Model model,
            @RequestParam int id,  // Change @PathVariable to @RequestParam
            @Valid @ModelAttribute ProductDto productDto,
            BindingResult result
    ) {
        try {
